/**
 * Pagination and Search functionality for Doctors List
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    const doctorRows = Array.from(document.querySelectorAll('.doctor-row'));
    ...
    function getVisibleRows() {
        return doctorRows.filter(row => {
            ...
            if (searchInput && searchInput.value.trim()) {
                ...
                const doctorIC = row.querySelector('.doctor-ic')?.textContent.toLowerCase() || '';
                return doctorName.includes(searchTerm) || doctorIC.includes(searchTerm);
            }
    ...
    function checkNoResults() {
        ...
        if (filteredRows.length === 0 && doctorRows.length > 0) {
