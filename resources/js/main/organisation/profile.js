document.addEventListener('DOMContentLoaded', function() {
    ...
    // Modal Toggle Logic
    const modals = {
        'openEditDetails': 'editDetailsModal',
        'openEditContact': 'editContactModal',
        'openEditPic': 'editPicModal',
        'openEditLegal': 'editLegalModal',
    ...
    document.querySelectorAll('.close-modal').forEach(btn => {
        btn.addEventListener('click', () => {
            const modal = btn.closest('.fixed.inset-0[id]'); // Find the parent modal container with an ID
            if (modal) {
