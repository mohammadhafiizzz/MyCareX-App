/**
 * Pagination and Search functionality for Patients List
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCounter() {
        if (patientsCount) {
            ...
            if (total === 0) {
                patientsCount.innerHTML = `Showing <span class="font-medium text-gray-900">0</span> patients`;
            } else {
                patientsCount.innerHTML = `Showing <span class="font-medium text-gray-900">${startIndex}-${endIndex}</span> of <span class="font-medium text-gray-900">${total}</span> patient${total !== 1 ? 's' : ''}`;
            }
        }
    }
    ...
    function checkNoResults() {
        ...
        if (filteredRows.length === 0 && patientRows.length > 0) {
