...
<body class="bg-white font-sans text-gray-900 p-8 max-w-7xl mx-auto">
    ...
    <div class="border-b-4 border-blue-600 pb-5 mb-8">
        <h1 class="text-4xl font-bold text-blue-900 mb-2">Allergies Report</h1>
    ...
    <div class="bg-blue-50 border-l-4 border-blue-500 rounded p-5 mb-8 page-break-avoid">
        ...
        <p class="text-sm text-blue-800">This report contains <strong>{{ $totalAllergies }}</strong> allergy{{ $totalAllergies !== 1 ? ' records' : '' }} on file.</p>
    </div>
    
    <div class="mt-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-gray-200">Allergies</h2>
        
        @forelse ($allergies as $allergy)
            <div class="border border-gray-200 rounded-xl p-6 mb-6 bg-white page-break-avoid">
                <div class="flex flex-wrap justify-between items-start gap-3 mb-4">
                    <h3 class="text-xl font-semibold text-gray-900">{{ $allergy['allergen'] }}</h3>
        ...
        @empty
            <div class="text-center py-16">
                <h3 class="text-lg font-semibold text-gray-700 mb-2">No Allergies Found</h3>
                <p class="text-sm text-gray-600">There are currently no allergies recorded in your health record.</p>
            </div>
        @endforelse
    </div>
