    ...
    >
        ...
        <form id="edit-allergy-form" class="mt-6 space-y-6" method="POST" action="#">
            ...
            <div>
                ...
                <div id="edit_allergy_type_select_wrapper" class="relative mt-1">
                    <select 
                        id="edit_allergy_type_select"
                ...
                <div id="edit_allergy_type_manual_wrapper" class="hidden mt-1 relative">
                    <input 
                        type="text" 
                        name="allergy_type" 
