{{-- Edit Hospitalisation Modal --}}
<div id="edit-hospitalisation-modal" class="fixed inset-0 z-50 bg-gray-950/50 hidden items-center justify-center p-4 overflow-y-auto" role="dialog" aria-labelledby="edit-hospitalisation-title" aria-modal="true">
    <div class="relative w-full max-w-lg p-6 my-8 text-left align-middle bg-white rounded-2xl shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <h3 id="edit-hospitalisation-title" class="text-xl font-semibold leading-6 text-gray-900">
                    Edit Hospitalisation
                </h3>
            </div>
            <button type="button" id="close-edit-hospitalisation-modal" class="text-gray-400 hover:text-gray-600 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 p-1">
        ...
        <div id="edit-form-error-message" class="hidden mb-4 p-4 bg-red-50 border border-red-200 rounded-lg text-sm text-red-800" role="alert">
            <!-- Errors will be inserted here by JavaScript -->
        </div>

        {{-- Modal Body --}}
        <form id="edit-hospitalisation-form" action="" method="POST" class="space-y-5">
            @csrf
            @method('PUT')

            {{-- Admission Date --}}
            <div>
                <label for="edit-admission-date" class="block text-sm font-semibold text-gray-700 mb-2">
            ...
            {{-- Discharge Date --}}
            <div>
                <label for="edit-discharge-date" class="block text-sm font-semibold text-gray-700 mb-2">
            ...
            <div>
                <label for="edit-reason-for-admission" class="block text-sm font-semibold text-gray-700 mb-2">
                    Reason for Admission <span class="text-red-500">*</span>
                </label>
                <input 
                    type="text" 
                    id="edit-reason-for-admission" 
            ...
            {{-- Provider Name --}}
            <div>
                <label for="edit-provider-name" class="block text-sm font-semibold text-gray-700 mb-2">
            ...
            {{-- Notes --}}
            <div>
                <label for="edit-notes" class="block text-sm font-semibold text-gray-700 mb-2">
            ...
            <div class="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-gray-200">
                <button 
                    type="button" 
                    id="cancel-edit-hospitalisation"
