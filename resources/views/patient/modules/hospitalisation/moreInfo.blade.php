...
<head>
    ...
    <title>MyCareX - Hospitalisation Details</title>
...
<body class="font-[Inter] bg-gray-50">
        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('patient.hospitalisation') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                        Hospitalisations
                    </a>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-gray-500">Hospitalisation Details</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <div class="relative flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                <div class="flex items-start gap-6">
                    <div class="flex-shrink-0 w-16 h-16 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                        <i class="fas fa-hospital-alt text-3xl" aria-hidden="true"></i>
                    </div>
                    <div>
                        <h1 class="text-3xl font-bold mb-3">{{ $hospitalisation->reason_for_admission }}</h1>
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="{{ route('patient.hospitalisation') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm text-white text-sm font-semibold rounded-lg border border-white/30 hover:bg-white/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2">
                        <i class="fas fa-arrow-left" aria-hidden="true"></i>
                        Back to List
                    </a>
                    @if(!$isProviderCreated)
                        <button type="button" class="edit-hospitalisation-btn inline-flex items-center gap-2 px-4 py-2 bg-white text-gray-900 text-sm font-semibold rounded-lg shadow-sm hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2" data-id="{{ $hospitalisation->id }}">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <section class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="text-xl font-semibold text-gray-900">Hospitalisation Information</h2>
                    </div>

                    {{-- Hospitalisation Details Grid --}}
                    <div class="space-y-6">
                        ...
                        <div class="p-4 bg-blue-50 rounded-lg border border-blue-100">
                            ...
                            <p class="text-sm text-gray-900 font-medium">{{ $hospitalisation->reason_for_admission }}</p>
                        </div>
                        ...
                        <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <p class="text-sm text-gray-900 font-medium">{{ $admissionDateLabel }}</p>
                        </div>

                        {{-- Discharge Date --}}
                        <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <h3 class="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                                <i class="far fa-calendar-check text-gray-600" aria-hidden="true"></i>
                                Discharge Date:
                            </h3>
                            <p class="text-sm text-gray-900 font-medium">{{ $dischargeDateLabel }}</p>
                        </div>
                        ...
                        @if($hospitalisation->provider_name)
                            <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                ...
                                <p class="text-sm text-gray-900 font-medium">{{ $hospitalisation->provider_name }}</p>
                            </div>
                        @endif
                        ...
                        <div>
                            ...
                            @if ($hospitalisation->notes)
                                <div class="prose prose-sm max-w-none p-4 bg-gray-50 rounded-lg border border-gray-200">
                                    <p class="text-gray-700 leading-relaxed whitespace-pre-wrap">{{ $hospitalisation->notes }}</p>
                                </div>
                            @else
                                <div class="text-center py-8 bg-gray-50 rounded-lg border border-gray-200">
                                    ...
                                    @if(!$isProviderCreated)
                                        <button type="button" class="edit-hospitalisation-btn inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-700 font-medium" data-id="{{ $hospitalisation->id }}">
            ...
            <div class="space-y-6">
                ...
                <section class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        @if(!$isProviderCreated)
                            <button type="button" class="edit-hospitalisation-btn w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-lg shadow-sm hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2" data-id="{{ $hospitalisation->id }}">
                                <i class="fas fa-pen-to-square" aria-hidden="true"></i>
                                Edit Hospitalisation
                            </button>
                            <button type="button" class="delete-hospitalisation-btn w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-red-600 text-sm font-semibold rounded-lg border border-red-200 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2" data-id="{{ $hospitalisation->id }}" data-reason="{{ $hospitalisation->reason_for_admission }}">
                            ...
                            <div class="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-purple-700">This hospitalisation was created by your healthcare provider and cannot be edited or deleted.</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        <a href="{{ route('patient.hospitalisation') }}" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-lg border border-gray-200 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2">
                            <i class="fas fa-arrow-left" aria-hidden="true"></i>
                            Back to List
                        </a>
                    </div>
                ...
                <section class="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6">
                    ...
                    <p class="text-xs text-gray-700 leading-relaxed">
                        Keep your hospitalisation records up-to-date to help your healthcare providers make informed decisions about your treatment plan.
                    </p>
                </section>
            </div>
        </div>
    ...
    <!-- Edit Hospitalisation Form -->
    @include('patient.modules.hospitalisation.editHospitalisationForm')
    
    <!-- Javascript and Footer -->
    @vite(['resources/js/main/patient/header.js'])
    @vite(['resources/js/main/hospitalisation/editHospitalisationForm.js'])
    @vite(['resources/js/main/hospitalisation/deleteHospitalisation.js'])
