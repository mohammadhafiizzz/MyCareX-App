...
<head>
    ...
    <title>Download {{ $medication['medication_name'] }}</title>
...
<body class="bg-white font-sans text-gray-900 p-8 max-w-7xl mx-auto">
    ...
    <div class="border-b-4 border-blue-600 pb-5 mb-8">
        <h1 class="text-4xl font-bold text-blue-900 mb-2">Medication: {{ $medication['medication_name'] }}</h1>
    ...
    <div class="mt-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-gray-200">{{ $medication['medication_name'] }}</h2>
        ...
        <div class="border border-gray-200 rounded-xl p-6 mb-6 bg-white page-break-avoid">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-800">{{ $medication['reason_for_med'] }}</div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                    <div>
                        ...
                        <div class="text-sm text-gray-800">{{ $medication['created_at'] }}</div>
                    </div>
                    <div>
                        <div class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Last Updated</div>
                        <div class="text-sm text-gray-800">{{ $medication['updated_at'] }}</div>
                    </div>
                </div>
            </div>
        </div>
