...
<head>
    ...
    <title>Download {{ $condition['condition_name'] }}</title>
...
<body class="bg-white font-sans text-gray-900 p-8 max-w-7xl mx-auto">
    ...
    <div class="border-b-4 border-blue-600 pb-5 mb-8">
        <h1 class="text-4xl font-bold text-blue-900 mb-2">Medical Condition: {{ $condition['condition_name'] }}</h1>
    ...
    <div class="mt-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-gray-200">{{ $condition['condition_name'] }}</h2>
