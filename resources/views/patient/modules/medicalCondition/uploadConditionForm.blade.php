    ...
    <div class="bg-white rounded-md shadow-2xl max-w-md w-full overflow-hidden transform transition-all">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                ...
                <button type="button" id="closeUploadModal" class="text-gray-900/80 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 rounded-lg p-1">
        ...
        <form id="uploadAttachmentForm" method="POST" action="{{ route('patient.condition.upload.attachment', $condition->id) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-6">
                ...
                <!-- File Input Area -->
                <div class="relative">
                    <input type="file" id="attachment" name="attachment" accept=".pdf,.png,.jpg,.jpeg" required class="hidden">
