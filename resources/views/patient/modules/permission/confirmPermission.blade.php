            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden h-full flex flex-col">
                    ...
                    <div class="p-6 sm:p-8 flex flex-col items-center text-center flex-1 justify-center">
                        ...
                        @if($permission->notes)
                        <div class="w-full pt-4 border-t border-gray-100 mt-2">
                            <label class="text-[10px] font-bold text-gray-400 uppercase block mb-2">Doctor's Note</label>
                            <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                                <p class="text-xs text-gray-700 italic">"{{ $permission->notes }}"</p>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <form id="approvePermissionForm" data-permission-id="{{ $permission->id }}">
                            ...
                            <div class="flex flex-col text-sm sm:flex-row justify-end gap-3 pt-6 border-t border-gray-100">
                                <button type="button" id="declineRequestBtn" class="px-4 py-2 bg-white text-red-600 font-semibold rounded-lg border border-red-200 hover:bg-red-50 transition-colors flex items-center justify-center gap-2">
                                    Decline Request
                                </button>
                                <button type="submit" id="grantAccessBtn" class="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-sm flex items-center justify-center gap-2">
                                    Grant Access
                                </button>
                            </div>
                        </form>
