...
<div id="uploadAttachmentModal" class="fixed inset-0 bg-gray-900/50 z-50 flex items-center justify-center p-4" style="display: none;">
    <div class="bg-white rounded-md shadow-2xl max-w-md w-full overflow-hidden transform transition-all">
        ...
        <!-- Modal Body -->
        <form id="uploadAttachmentForm" method="POST" action="{{ route('patient.lab.upload.attachment', $labTest->id) }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <!-- File Input Area -->
                <div class="relative">
                    <input type="file" id="file_attachment" name="file_attachment" accept=".pdf, .png, .jpg, .jpeg" required class="hidden">
