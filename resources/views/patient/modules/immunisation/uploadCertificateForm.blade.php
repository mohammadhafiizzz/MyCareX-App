...
<div id="uploadCertificateModal" class="fixed inset-0 bg-gray-900/50 z-50 flex items-center justify-center p-4" style="display: none;">
    <div class="bg-white rounded-md shadow-2xl max-w-md w-full overflow-hidden transform transition-all">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                ...
                <button type="button" id="closeUploadModal" class="text-gray-700 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 rounded-lg p-1">
        ...
        <!-- Modal Body -->
        <form id="uploadCertificateForm" method="POST" action="{{ route('patient.immunisation.upload.certificate', $immunisation->id) }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <!-- File Input Area -->
                <div class="relative">
                    <input type="file" id="certificate" name="certificate" accept=".pdf, .png, .jpg, .jpeg" required class="hidden">
                    <div id="fileDropArea" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-blue-400 hover:bg-blue-50/50 transition">
                        <div id="fileDropContent">
                            <i class="fas fa-cloud-arrow-up text-4xl text-gray-400 mb-3" aria-hidden="true"></i>
