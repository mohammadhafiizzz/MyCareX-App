            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <section class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    @if ($immunisation->certificate_url)
                        @php
                            $fileExtension = strtolower(pathinfo($immunisation->certificate_url, PATHINFO_EXTENSION));
                        ...
                        <div class="mb-6">
                            ...
                            @if ($isImage)
                                ...
                                <div class="rounded-lg border border-gray-200 bg-gray-50 overflow-hidden">
                                    <a href="{{ $immunisation->certificate_url }}" target="_blank" class="block group">
                                        <div class="relative">
                                            <img src="{{ $immunisation->certificate_url }}" alt="Vaccination Certificate" class="w-full h-auto max-h-96 object-contain bg-white">
            ...
            <div class="space-y-6">
                ...
                <section class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('patient.immunisation.download', $immunisation->id) }}" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-white text-gray-700 text-sm font-medium rounded-lg border border-gray-200 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-200">
                            <i class="fas fa-download" aria-hidden="true"></i>
                            Download
                        </a>
                        <hr class="mt-4 mb-5 border-gray-300">
                        <button type="button" onclick="openDeleteModal('immunisation')" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-red-50 text-red-700 text-sm font-semibold rounded-lg border border-red-200 hover:bg-red-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400">
                            <i class="fas fa-trash" aria-hidden="true"></i>
                            Delete
                        </button>
                    </div>
    ...
    <script>
        function openDeleteModal(type) {
            ...
            if (type === 'immunisation') {
                ...
                title.innerText = 'Delete Certificate';
                description.innerText = 'Are you sure you want to delete this attachment? This action cannot be undone.';
                form.action = "{{ route('patient.immunisation.delete.certificate', $immunisation->id) }}";
                submitBtn.innerText = 'Delete Certificate';
            }
