    ...
    <div class="lg:ml-68 transition-all duration-300 mt-20" id="mainContent">
        <div class="bg-gray-50 min-h-screen">
            ...
            <div class="py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Admin Verification</h1>
                    <p class="text-xs sm:text-sm text-gray-500">Review and manage pending admin account verification requests.</p>
                </div>
                ...
                <section class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8" aria-labelledby="requests-heading">
                    <div class="p-4 sm:p-6">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                            <div>
                                <h2 id="requests-heading" class="text-lg sm:text-xl font-semibold text-gray-900">New Requests</h2>
                                <p class="mt-1 text-xs sm:text-sm text-gray-600">Pending admin accounts awaiting approval.</p>
                            </div>
                        </div>
                        ...
                        @if ($totalAdmins > 0)
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                                <p class="text-sm text-gray-500" id="admins-count">
                                    Showing <span class="font-medium text-gray-900">{{ count($admins) }}</span> request{{ count($admins) !== 1 ? 's' : '' }}
                                </p>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col" class="hidden lg:table-cell px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Registration Date</th>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse ($admins as $admin)
                                            <tr class="admin-row hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-medium bg-amber-100 text-amber-800">
                                                        Pending
                                                    </span>
                                                </td>
                                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="{{ route('admin.management.requestInfo', $admin->admin_id) }}" 
                                ...
                                <div class="text-center py-16">
                                    <div class="relative inline-block mb-6">
                                        <div class="w-32 h-32 bg-blue-100 rounded-full flex items-center justify-center">
                                            <i class="fas fa-user-clock text-blue-600 text-5xl" aria-hidden="true"></i>
                                        </div>
                                    </div>
                                    ...
                                    <p class="max-w-xl mx-auto text-base text-gray-600 mb-8">
                                        There are currently no new admin account verification requests.
                                    </p>
                                </div>
                            @endif
