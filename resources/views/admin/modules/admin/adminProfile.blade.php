    ...
    <div class="lg:ml-68 transition-all duration-300 mt-20" id="mainContent">
        <div class="min-h-screen">
            ...
            <div class="py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-4">
                    <a href="{{ route('admin.management') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium inline-flex items-center gap-1">
                        <i class="fa-solid fa-arrow-left text-xs"></i> Back to Admin Management
                    </a>
                </div>

                <div class="mb-8">
                    <h1 class="text-2xl font-bold text-gray-900">Admin Profile</h1>
                    <p class="text-sm text-gray-500">View and manage administrator details.</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="p-6 sm:p-8 flex flex-col items-center text-center">
                                ...
                                <div class="mb-2">
                                    ...
                                    @elseif($admin->account_rejected_at)
                    ...
                    <div class="bg-white rounded-xl lg:col-span-2 shadow-sm border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                            <h3 class="text-sm sm:text-md font-bold text-gray-900 flex items-center gap-2">
                                <i class="fa-solid fa-id-card text-gray-400"></i> ADMIN INFORMATION
                            </h3>
                        </div>
                        ...
                        <div class="p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-y-8 gap-x-8">
                            ...
                            <div>
                                <label class="text-xs font-bold text-gray-400 uppercase block mb-1">Role</label>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900 font-medium">{{ $admin->created_at->format('d M Y') }}</p>
                            </div>
                            <div>
                            ...
                            <div class="p-4 sm:p-6 space-y-2">
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between py-3 border-b border-gray-50 gap-2">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">Last login: {{ $admin->last_login ? $admin->last_login->diffForHumans() : 'Never' }}</p>
                                    </div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between py-4 gap-3">
                                    <div>
                                        <p class="text-sm font-medium text-red-600">Remove Admin</p>
                                        <p class="text-xs text-red-400">Permanently remove this administrator from the system</p>
                                    </div>
                                    <button class="remove-admin-btn w-full sm:w-auto px-4 py-2 text-xs font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 transition-colors border border-red-100" data-id="{{ $admin->admin_id }}">
                                        Remove Admin
                                    </button>
                                </div>
                            </div>
