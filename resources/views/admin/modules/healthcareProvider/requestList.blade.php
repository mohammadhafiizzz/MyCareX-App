...
<head>
    ...
    <title>Healthcare Provider Requests</title>
    ...
    <div class="lg:ml-68 transition-all duration-300 mt-20" id="mainContent">
        <div class="bg-gray-50 min-h-screen">
            ...
            <div class="py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Verification Requests</h1>
                    <p class="text-xs sm:text-sm text-gray-500">Review and manage pending and rejected healthcare provider registration requests.</p>
                </div>
                ...
                <section class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8" aria-labelledby="providers-heading">
                    <div class="p-4 sm:p-6">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                            <div>
                                <h2 id="providers-heading" class="text-lg sm:text-xl font-semibold text-gray-900">Verification Requests</h2>
                                <p class="mt-1 text-xs sm:text-sm text-gray-600">Search and manage healthcare providers awaiting approval or previously rejected.</p>
                            </div>
                        </div>
                        ...
                        @if ($totalProviders > 0)
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                                <p class="text-sm text-gray-500" id="providers-count">
                                    Showing <span class="font-medium text-gray-900">{{ count($providers) }}</span> request{{ count($providers) !== 1 ? 's' : '' }}
                                </p>
                        ...
                        <div id="providers-list">
                                            ...
                                            @foreach ($providers as $provider)
                                                <tr class="provider-row hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <a href="{{ route('admin.providerVerification', $provider->id) }}" 
                                ...
                                <div class="text-center py-16">
                                    <div class="relative inline-block mb-6">
                                        <div class="w-32 h-32 bg-blue-100 rounded-full flex items-center justify-center">
                                            <i class="fas fa-clipboard-list text-blue-600 text-5xl" aria-hidden="true"></i>
                                        </div>
                                    </div>

                                    <h3 class="text-2xl font-bold text-gray-900 mb-3">No verification requests</h3>
                                    <p class="max-w-xl mx-auto text-base text-gray-600 mb-8">
                                        There are currently no healthcare providers awaiting verification or in rejected status.
                                    </p>
                                </div>
                            @endif
                            ...
                            <div id="no-search-results" class="hidden text-center py-12">
                                ...
                                <p class="text-sm text-gray-600 mb-4">We couldn't find any pending requests matching your search</p>
