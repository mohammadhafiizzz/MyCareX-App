            ...
            <div class="mx-auto w-full max-w-lg lg:w-130">
                ...
                <div class="border border-gray-200 p-8 rounded-lg shadow-sm bg-white">
                    <div class="mb-6 text-center">
                        ...
                        <p class="mt-4 text-sm text-gray-600 mb-8">Enter the email address you used to register your organisation. We will send you a link to reset your password.</p>
                    </div>
                    ...
                    <!-- Registration Form -->
                    <form action="{{ route('organisation.password.email') }}" method="POST" class="space-y-6">
                        @csrf
