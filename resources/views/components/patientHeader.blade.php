    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 p-2">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden lg:flex items-center space-x-4 font-medium">
                <!-- Notification Button -->
                <button class="relative px-4 py-2 text-gray-800 rounded-lg hover:bg-gray-100 transition-colors duration-200" id="notificationBtn">
                ...
                <div class="relative" id="profileDropdown">
                    <button class="flex items-center px-4 py-2 text-gray-800 rounded-lg hover:bg-gray-100 transition-colors duration-200" id="profileBtn">
